#!/usr/bin/env python3
"""Qwen3-4B-Instruct-2507 generate on the hoid kernel stack — no hoid runtime.

Builds the engine from qwen3_optimized.py (the winning decode kernels under a
CUDA-graph-captured step; prefill on the shape-generic elastic stack at any
...
def main():
    ...
    eng = Q.Qwen3Optimized(weights, max_seq=P + G + 2)
    eng.capture()
